...
DEFAULT_REGISTER_CONTRACT_FEE = 100*TV
DEFAULT_EXECUTE_CONTRACT_FEE = int(0.3*TV)
DEFAULT_CONTEND_SLOT_FEE = 50000 * TV
DEFAULT_RELEASE_SLOT_FEE = DEFAULT_TX_FEE
DEFAULT_DBPUT_FEE = 1 * TV
...
MIN_CONTEND_SLOT_BALANCE = 1000000 * TV
