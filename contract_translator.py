...
class ContractTranslator(object):
    ...
    def contract_from_json(contract):
        ...
        textuals = [base58.b58decode(contract['textual']['triggers']), base58.b58decode(contract['textual']['descriptors']),
                    base58.b58decode(contract['textual']['stateVariables'])]

        contract_bytes_string = contract_build.create(contract['languageCode'], contract['languageVersion'],
